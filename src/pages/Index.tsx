...
const Index = () => (
  <Layout>
    {/* Hero — Full viewport, exact reference layout */}
      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-12 md:pb-20">
        <div className="container">
          <AnimatedSection className="max-w-4xl">
            {/* Title */}
            <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-bold leading-[1.05] mb-6">
              <span className="text-white">Two Markets</span>
              <br />
              <span className="italic bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-cyan-300">One Language.</span>
            </h1>

            {/* Description + Button row */}
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
              <p className="text-sm md:text-base text-white/80 max-w-lg leading-relaxed italic">
              ...
              <Button asChild className="rounded-full bg-white hover:bg-white/90 text-black font-semibold px-10 py-6 text-sm tracking-[0.25em] uppercase shrink-0">
      ...
      <div className="container">
        <AnimatedSection className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-8 text-white">
            ...
            <span className="italic bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-cyan-300">We translate culture.</span>
          </h2>
        </AnimatedSection>
        <AnimatedSection delay={0.1} className="max-w-3xl mx-auto">
          <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 md:p-12 space-y-5 text-white/70 leading-relaxed text-base md:text-lg">
            <p>Too often, brands treat international expansion as a logistical exercise. A website here, a social account there. But entering China—or the UK—demands something more nuanced: fluency in behaviour, humour, context, and trust.</p>
            <p>Based in London, Two Virtual Media exists to bridge that gap. We work with British brands navigating China's distinct digital ecosystem, and Chinese brands building recognition and credibility in the UK.</p>
          </div>
        </AnimatedSection>
      </div>
    </section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {stats.map((s, i) => (
            <AnimatedSection key={s.label} delay={i * 0.08}>
              <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-center hover:border-cyan-400/30 transition-all duration-500">
                <p className="font-heading text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-cyan-300 mb-2">{s.value}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <AnimatedSection delay={0.1}>
            <div className="rounded-xl border border-white/10 bg-white/5 p-8 md:p-10 h-full hover:border-cyan-400/30 transition-all duration-500">
              ...
              <p className="text-white/60 leading-relaxed">We help you build presence across WeChat, Xiaohongshu, Douyin, and beyond. From strategy to content to KOL partnerships, we ensure your brand connects with Chinese consumers—without losing your identity.</p>
            </div>
          </AnimatedSection>
          <AnimatedSection delay={0.2}>
            <div className="rounded-xl border border-white/10 bg-white/5 p-8 md:p-10 h-full hover:border-cyan-400/30 transition-all duration-500">
              <h3 className="font-heading text-xl font-semibold text-white mb-4">For Chinese Brands Entering the UK</h3>
              <p className="text-white/60 leading-relaxed">We help you tell your story for a British audience. Through Western social platforms, PR, influencer campaigns, and brand positioning, we build the credibility and visibility you need to grow.</p>
            </div>
          </AnimatedSection>
        </div>
      </div>
      ...
      <div className="container text-center">
        <AnimatedSection>
          <h2 className="font-heading text-3xl md:text-5xl font-bold mb-6 text-white">
            ...
            <span className="italic bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-cyan-300">extraordinary.</span>
          </h2>
          <p className="text-lg text-white/60 mb-10 max-w-xl mx-auto">Ready to bridge the gap between UK and China?</p>
          <Button asChild size="lg" className="rounded-full bg-white hover:bg-white/90 text-black font-semibold px-10 py-6 text-base tracking-[0.25em] uppercase">
